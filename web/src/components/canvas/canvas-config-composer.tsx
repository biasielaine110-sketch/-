        ...
        >
            ...
            <div className="relative rounded-xl">
                ...
                <div
                    ...
                    className="thin-scrollbar min-h-28 max-h-72 w-full cursor-text select-text overflow-y-auto overscroll-contain whitespace-pre-wrap break-words px-3 py-2 text-sm leading-7 outline-none"
